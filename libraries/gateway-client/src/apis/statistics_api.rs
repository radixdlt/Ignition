...
pub fn validators_uptime(
    ...
    validators_uptime_request: crate::models::ValidatorsUptimeRequest,
) -> Result<crate::models::ValidatorsUptimeResponse, Error<ValidatorsUptimeError>>
{
    ...
    local_var_req_builder =
        local_var_req_builder.json(&validators_uptime_request);
